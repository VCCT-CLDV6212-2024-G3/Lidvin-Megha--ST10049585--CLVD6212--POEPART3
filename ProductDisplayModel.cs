...
namespace CLVD6212_POEPART3.Models
{
    public class ProductDisplayModel
    {
        ...
        public static List<ProductDisplayModel> SelectProducts()
        {
            ...
            string con_string = "Server=tcp:st10049585server.database.windows.net,1433;Initial Catalog=st10049585serviceapp;Persist Security Info=False;User ID=st10049585function;Password=Francis@123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
